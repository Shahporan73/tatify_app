                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          heightBox5,
                          CustomRowWidget(
                              title: Text('Date : ', style: keyStyle,),
                              value: Text('1/14/2025', style: keyStyle,)
                          ),
                          CustomRowWidget(
                              title: Text('Name :', style: keyStyle,),
                              value: Text('Istiak Ahmed', style: keyStyle,)
                          ),
                          CustomRowWidget(
                              title: Text('Gmail :', style: keyStyle,),
                              value: Text('abc123@gmail.com', style: keyStyle,)
                          ),
                          CustomRowWidget(
                              title: Text('Phone Number :', style: keyStyle,),
                              value: Text('123456789', style: keyStyle,)
                          ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        widthBox10,
                        CustomText(title: 'Complete', fontWeight: FontWeight.w600, color: AppColors.black100, fontSize: 18,)
                      ],
                    ),
                    SizedBox(
                      height: height / 18,
